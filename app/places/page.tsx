        ...
        <div className="container px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-400 mb-6">
              Discover amazing restaurants, cafes, and dining venues across Sri
              Lanka. Find the perfect place for your next meal or coffee break.
            </p>
            ...
            <div className="text-center py-16">
              <div className="max-w-md mx-auto">
                ...
                <p className="text-gray-600 mb-6">
                  Check back soon for amazing restaurants and cafes across Sri
                  Lanka.
                </p>
                <Button asChild>
  ...
  return (
    ...
    >
      <div className="relative h-48 w-full overflow-hidden">
        ...
        {place.isOpen !== null && (
          <div
            className={`absolute right-4 bottom-4 rounded-full px-3 py-1 text-xs font-medium text-white ${
      ...
      <div className="p-6">
        ...
        {place.vibe && place.vibe.length > 0 && (
          <div className="flex flex-wrap gap-2 mb-4">
            {place.vibe.slice(0, 2).map((vibe: string, index: number) => (
        ...
        {place.publishedAt && (
          <div className="flex items-center gap-2 text-xs text-gray-400 mb-4">
            ...
            <span>
              Published {new Date(place.publishedAt).toLocaleDateString()}
            </span>
          </div>
        )}

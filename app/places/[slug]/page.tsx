...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      place.description ||
      `Visit ${place.name} in Sri Lanka. Discover amazing restaurants and cafes with Kohedha.`,
    keywords: [
      place.category,
      "Sri Lanka",
      "restaurants",
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="container px-4 text-center text-white">
            <div className="mb-4 flex justify-center gap-2">
              <Badge
                className="bg-black px-3 py-1 text-sm font-medium"
                style={
                  place.categoryColor
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        ...
                        {place.location.district && (
                          <div>{place.location.district}</div>
                        )}
                      </div>
                    </div>
                  )}
                  ...
                  <CardContent className="space-y-3">
                    ...
                    {place.contactInfo.whatsapp && (
                      <div className="flex items-center gap-3">
                        ...
                        <a
                          href={`https://wa.me/${place.contactInfo.whatsapp}`}
